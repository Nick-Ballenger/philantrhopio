...
export const loginSuccess = (cred) => (dispatch) => {
	...
	return axios
		.post('https://philanthropio.herokuapp.com/api/auth/login', cred)
		.then((res) => {
...
export const registerSuccess = (cred) => (dispatch) => {
	...
	return axios
		.post('https://philanthropio.herokuapp.com/api/auth/register', cred)
		.then((res) => {
			localStorage.setItem('token', res.data.token);
			localStorage.setItem('userID', res.data.userID);
			dispatch({
...
export const getBooks = () => (dispatch) => {
	...
	axios
		.get('https://philanthropio.herokuapp.com/api/books/')
		.then((res) => {
			dispatch({
...
export const getBookPage = (id) => (dispatch) => {
	...
	axios
		.get(`https://philanthropio.herokuapp.com/api/books/${id}`)
		.then((res) => {
			dispatch({
...
export const deleteBook = (id) => (dispatch) => {
	...
	axios
		.delete(`https://philanthropio.herokuapp.com/api/books/${id}`)
		.then((res) => {
...
export const updateBook = (id,bookUpdate) => (dispatch) => {
	...
	axios
		.put(`https://philanthropio.herokuapp.com/api/books/${id}`,bookUpdate)
		.then((res) => {
...
export const addReview = (newReview) => (dispatch) => {
	...
	axios
		.post('https://philanthropio.herokuapp.com/api/reviews', newReview)
		.then((res) => {
